...
class Position_Holonomichp
{
    public:
        __fp16 x;
        __fp16 y;
        Position_Holonomichp()//builder
        {
            x = 0;
            y = 0;
        }
        Position_Holonomichp(__fp16 _x, __fp16 _y)//builder
        {
            x = _x;
            y = _y;
        }
        ~Position_Holonomichp()//destroyer
        {
            //cout<< "Destructor Position_Holonomic"<<endl;
        }
        void Insert_Position(__fp16 _x, __fp16 _y)
        {
            x = _x;
            y = _y;
        }
        void Copy(Position_Holonomichp &A)
        {
            x = A.x;
            y = A.y;
        }
    ...
    class Node_RRT_Pos
    {
        public:
            ...
            void Copy(Node_RRT_Pos &A)//Copy Node
            {
    ...
    public:
    	...
    	~Node_RRT_nb()//destroyer
    	{
    		//cout<<"Destructor Node_RRT"<<endl;
    	}
    	void Copy(Node_RRT_nb &A)//Copy Node
    	{
    ...
    public:
    	...
    	Position_Holonomichp Position;//Position of the Node
    	short int Location_List;
    	__fp16 Cost;
    	...
    	~Node_RRT_hp()//destroyer
    	{
    		//cout<<"Destructor Node_RRT"<<endl;
    	}
    	void Copy(Node_RRT_hp &A)//Copy Node
    	{
